...
CREATE INDEX idx_country_continent ON countries (region);
CREATE INDEX idx_country_subregion ON countries (subregion);

CREATE INDEX idx_country_region ON states (country_id);
ALTER TABLE states
